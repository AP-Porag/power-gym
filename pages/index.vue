<template>
  <div class="index">
          ...
          <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
            ...
            <li class="flex items-center">
              <a
                ...
                href="#pablo"
              ><i
                class="text-yellow-500 fab fa-facebook text-lg leading-lg"
              ></i
            ...
            <li class="flex items-center">
              <a
                ...
                href="#pablo"
              ><i
                class="text-yellow-500 fab fa-twitter text-lg leading-lg"
              ></i
            ...
            <li class="flex items-center">
              <a
                ...
                href="#pablo"
              ><i
                class="text-yellow-500 fab fa-linkedin text-lg leading-lg"
              ></i
    ...
    <main>
      ...
      >
        <div
          class="absolute top-0 w-full h-full bg-top bg-cover hero_bg">
          <span
            id="blackOverlay"
            ...
            <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
              <div>
                <h1 class="text-white font-semibold text-5xl">
                  Feel The <span class="text-yellow-500">Power</span>
                </h1>
                ...
                <a
                  href="#"
                  class="bg-transparent hover:bg-yellow-500 text-yellow-500 font-semibold hover:text-white p-4 border border-orange-500 hover:border-transparent rounded inline-block mt-5 cursor-pointer"
                >Download Brochure</a
                >
              </div>
            </div>
      ...
      <section id="about" class="relative py-20 bg-black text-white">
        <div class="container mx-auto px-4">
          <div class="items-center flex flex-wrap">
            ...
            >
              <div class="md:pr-12">
                <small class="text-yellow-500">About our gym</small>
                ...
                <ul class="list-none mt-6">
                  <li class="py-2">
                    <div class="flex items-center">
                      <div>
                        <span
                          class="font-semibold inline-block py-3 mr-3 text-yellow-500"
        ...
        <div class="container mx-auto px-4">
          <div class="flex flex-wrap justify-center lg:-mt-64 -mt-48">
            <div class="w-full lg:w-6/12 px-4">
              ...
              >
                <div class="flex-auto p-5 lg:p-10 bg-yellow-500 text-white">
          ...
          <div class="w-full lg:w-6/12 px-4">
            ...
            <div class="mt-6">
              <button
                ...
                type="button"
              >
                <i class="flex fab fa-twitter text-yellow-500"></i></button
              ><button
              class="bg-white text-blue-600 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 p-3"
              type="button"
            >
              <i
                class="flex fab fa-facebook-square text-yellow-500"
              ></i></button
            ><button
              class="bg-white text-pink-400 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 p-3"
              type="button"
            >
              <i class="flex fab fa-linkedin text-yellow-500"></i>
            </button>
            </div>
          </div>
        </div>
